...
root.title("Retinal Vessels Detection System")
w,h = root.winfo_screenwidth(),root.winfo_screenheight()

#####For background Image
image2 = Image.open(r'C:\Users\HP\OneDrive\Desktop\project\21C9342_100%_Retinal_Vessels\55.jpg')
...
w = tk.Label(root, text="Retinal Vessels Detection System",width=75,background="#668B8B",foreground="white",height=2,font=("Times new roman",29,"bold"))
w.place(x=0,y=0)
...
button1 = tk.Button(root,text='Choose Image',command=Choose,font=('Times New Roman',15,'bold'),width=14,bg='#6959CD',fg='black')
button1.place(x=50,y=250)
def on_enter(e):
  button1['background'] = '#EEC900'

def on_leave(e):
  button1['background'] = '#6959CD'
...
label_l1 = tk.Label(root, text="**Retinal Vessels Detection System @2023 By **",font=("Times New Roman", 10, 'bold'),
