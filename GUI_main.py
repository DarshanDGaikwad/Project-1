...
#
label_l1 = tk.Label(root, text="Retinal Vessels Detection System",font=("Times New Roman", 30, 'bold'),
                    background="#4F4F4F", fg="white", width=30, height=1)
label_l1.place(x=470, y=20)
